...
urlpatterns = [
    ...
    path('casa<int:house_pk>/upload/', views.upload_listing_picture, name="house_upload_picture"),
    path('casa/delete_picture/<int:picture_pk>/', views.delete_listing_picture, name="house_delete_picture"),
